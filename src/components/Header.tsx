...
//   return (
//     <header className="sticky top-0 z-50 bg-white shadow-[0_1px_0_0_#E8E8F0]">
...
//               </svg>
//             </span>
//             <span className="text-[16px] md:text-[17px] font-serif font-bold tracking-tight text-[#1A1A2E]">
//               {SITE_NAME}
//             </span>
//           </Link>
